...
markup = ReplyKeyboardMarkup([[button1, button2]], one_time_keyboard=True)

def start(update, context):
    text = """
    👋 Добро пожаловать в наш бот! 👋
    Мы поможем вам найти информацию о проектах и навыках.
    """
...
def project(update, context):
    ...
    text = f"""
    📊 Информация о проекте {project_name}:
    * Описание: ...
    * Навыки: ...
    """
    context.bot.send_message(chat_id=update.effective_chat.id, text=text, parse_mode='Markdown')
...
def info(update, context):
    ...
    /projects - вывод списка проектов
    /project <project_name> - вывод информации о проекте
    /skills - вывод списка навыков
    /skill <skill_name> - вывод информации о навыке
    """
